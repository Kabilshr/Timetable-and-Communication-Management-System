...
<header class="admin-topbar">
    <div class="topbar-container">
        ...
        <div class="topbar-right" style="display: flex; align-items: center; gap: 16px;">
            <a href="<%= topPath %>/${sessionScope.user.role.toLowerCase()}-dashboard?view=profile" class="user-box" style="display: flex; align-items: center; gap: 8px; font-size: 0.9rem; font-weight: 600; text-decoration: none; color: inherit;">
